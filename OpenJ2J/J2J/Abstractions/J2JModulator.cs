...
{
    public abstract class J2JModulator : IDisposable
    {
        #region ::Variables::
        ...
        public J2JModulator(FileStream fileStream)
        {
        ...
        public abstract bool Modulate(string outputPath);

        public abstract bool Modulate(string outputPath, string password);
